  ...
  return (
    <div>
      <main className="flex-1  overflow-y-auto w-full font-roboto">
        <div className="text-2xl font-bold text-white mb-4 bg-[#1398DB] w-[80%] lg:w-1/3 px-3 py-2 my-[15px]  mx-auto rounded-md">
          Student Payment Report
        </div>

        <div className="flex justify-center lg:justify-start items-center px-6 my-4">
          <Link to="/add-courses">
              ...
              <table className=" text-center">
                ...
                <thead className="bg-[#00A99D] rounded-md whitespace-nowrap">
                  <tr className="text-center lg:text-base text-sm ">
                    ...
                    <th className="p-3">Payment Status & Transection ID</th>
