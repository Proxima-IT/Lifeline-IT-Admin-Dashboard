  ...
  return (
    <div>
      <main className="flex-1  overflow-y-auto w-full font-roboto">
        <div className="text-2xl font-bold text-white  bg-[#1398DB] w-1/2 lg:w-1/4 px-3 py-2 my-[15px]  mx-auto rounded-md">
          All Courses
        </div>
      ...
      <main class="flex-1 my-5 p-3">
        <div class="">
          ...
          <div className="bg-[#132949] border border-[#00B5FF] rounded-2xl p-4 lg:p-6 my-3 mx-3 lg:mx-10">

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4  gap-5 mt-6">
              {courses.map((course) => (
                <div
                  key={course._id}
